...
function render(tokens, context, partials, stream, callback) {
  var dataFile = process.cwd() + '/controllers/' + tokens.filename.replace('.node', '.js');
  try {
    require(dataFile).main(function dataRequireAtRender(context){
      console.log(tokens.filename + ':', context);
